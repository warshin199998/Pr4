...
public class BuergeraemterView {
    ...
    public BuergeraemterView(BuergeraemterControl buergeraemterControl, Stage primaryStage, BuergeraemterModel buergeraemterModel){
